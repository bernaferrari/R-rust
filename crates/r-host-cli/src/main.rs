...
fn read_input(prompt: &str, completer: &mut dyn FnMut(&str) -> Vec<String>) -> io::Result<Input> {
...
fn handle_tab(prompt: &str, buf: &mut Vec<u8>, completer: &mut dyn FnMut(&str) -> Vec<String>) {
