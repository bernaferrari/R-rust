...
pub(super) const UNEVALUATED_BUILTINS: &[UnevaluatedBuiltin] = &[
    ...
    UnevaluatedBuiltin {
        name: "unit",
        handler: crate::mainutils::portable_grid::do_unit,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
    ...
    UnevaluatedBuiltin {
        name: "viewport",
        handler: crate::mainutils::portable_grid::do_viewport,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "vpPath",
        handler: crate::mainutils::portable_grid::do_vp_path,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.layout",
        handler: crate::mainutils::portable_grid::do_grid_layout,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "pushViewport",
        handler: crate::mainutils::portable_grid::do_push_viewport,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
    ...
    UnevaluatedBuiltin {
        name: "downViewport",
        handler: crate::mainutils::portable_grid::do_down_viewport,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
    ...
    UnevaluatedBuiltin {
        name: "grid.newpage",
        handler: crate::mainutils::portable_grid::do_grid_newpage,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "convertX",
        handler: crate::mainutils::portable_grid::do_convert_x,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "convertY",
        handler: crate::mainutils::portable_grid::do_convert_y,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "convertWidth",
        handler: crate::mainutils::portable_grid::do_convert_width,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "convertHeight",
        handler: crate::mainutils::portable_grid::do_convert_height,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.draw",
        handler: crate::mainutils::portable_grid::do_grid_draw,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "gList",
        handler: crate::mainutils::portable_grid::do_glist,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "gTree",
        handler: crate::mainutils::portable_grid::do_gtree,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grobTree",
        handler: crate::mainutils::portable_grid::do_grobtree,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
    ...
    UnevaluatedBuiltin {
        name: "grobWidth",
        handler: crate::mainutils::portable_grid::do_grob_width,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grobHeight",
        handler: crate::mainutils::portable_grid::do_grob_height,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "rectGrob",
        handler: crate::mainutils::portable_grid::do_rect_grob,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.rect",
        handler: crate::mainutils::portable_grid::do_grid_rect,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "circleGrob",
        handler: crate::mainutils::portable_grid::do_circle_grob,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.circle",
        handler: crate::mainutils::portable_grid::do_grid_circle,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "linesGrob",
        handler: crate::mainutils::portable_grid::do_lines_grob,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.lines",
        handler: crate::mainutils::portable_grid::do_grid_lines,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "polygonGrob",
        handler: crate::mainutils::portable_grid::do_polygon_grob,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.polygon",
        handler: crate::mainutils::portable_grid::do_grid_polygon,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "segmentsGrob",
        handler: crate::mainutils::portable_grid::do_segments_grob,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.segments",
        handler: crate::mainutils::portable_grid::do_grid_segments,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "textGrob",
        handler: crate::mainutils::portable_grid::do_text_grob,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.text",
        handler: crate::mainutils::portable_grid::do_grid_text,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "pointsGrob",
        handler: crate::mainutils::portable_grid::do_points_grob,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
        name: "grid.points",
        handler: crate::mainutils::portable_grid::do_grid_points,
        restore_visibility_always: false,
    },
    #[cfg(feature = "renderplot-device")]
    UnevaluatedBuiltin {
...
pub(super) const EVALUATED_BUILTINS: &[EvaluatedBuiltin] = &[
    ...
    EvaluatedBuiltin {
        name: "qr.qty",
        handler: crate::mainutils::qr_apply::do_qr_qty,
    },
    EvaluatedBuiltin {
        name: "qr.Q",
    ...
    EvaluatedBuiltin {
        name: "qr.fitted",
        handler: crate::mainutils::qr_fitted::do_qr_fitted,
    },
    EvaluatedBuiltin {
        name: "qr.resid",
        handler: crate::mainutils::qr_fitted::do_qr_resid,
    },
    EvaluatedBuiltin {
        name: "qr.X",
        handler: crate::mainutils::qr_x::do_qr_X,
    },
    EvaluatedBuiltin {
        name: "qr",
    ...
    EvaluatedBuiltin {
        name: ".rport_grid",
        handler: crate::mainutils::portable_grid::dispatch,
    },
    EvaluatedBuiltin {
        name: ".rport_pretty",
    ...
    EvaluatedBuiltin {
        name: ".Date",
        handler: crate::mainutils::essentials::do_dot_Date,
    },
    EvaluatedBuiltin {
        name: "sessionInfo",
        handler: crate::mainutils::essentials::do_sessionInfo,
    },
    EvaluatedBuiltin {
        name: ".POSIXct",
    ...
    EvaluatedBuiltin {
        name: "intToBits",
        handler: crate::mainutils::essentials::do_intToBits,
    },
    EvaluatedBuiltin {
        name: "rawToBits",
    ...
    EvaluatedBuiltin {
        name: "validUTF8",
        handler: crate::mainutils::essentials::do_validUTF8,
    },
    EvaluatedBuiltin {
        name: "validEnc",
        handler: crate::mainutils::essentials::do_validEnc,
    },
    EvaluatedBuiltin {
        name: "gettext",
        handler: crate::mainutils::essentials::do_gettext,
    },
    EvaluatedBuiltin {
        name: "ngettext",
    ...
    EvaluatedBuiltin {
        name: "bw.nrd0",
        handler: crate::mainutils::essentials::do_bw_nrd0,
    },
    EvaluatedBuiltin {
        name: "bw.nrd",
    ...
    EvaluatedBuiltin {
        name: "julian",
        handler: crate::mainutils::essentials::do_julian,
    },
    EvaluatedBuiltin {
        name: "julian.POSIXt",
        handler: crate::mainutils::essentials::do_julian,
    ...
    EvaluatedBuiltin {
        name: "expand.grid",
        handler: crate::mainutils::essentials::do_expand_grid,
    },
    EvaluatedBuiltin {
        name: "stack",
        handler: crate::mainutils::essentials::do_stack,
    },
    EvaluatedBuiltin {
        name: "unstack",
    ...
    EvaluatedBuiltin {
        name: "mad",
        handler: crate::mainutils::essentials::do_mad,
    },
    EvaluatedBuiltin {
        name: "fivenum",
        handler: crate::mainutils::essentials::do_fivenum,
    },
    EvaluatedBuiltin {
        name: "boxplot.stats",
    ...
    EvaluatedBuiltin {
        name: "cor.test",
        handler: crate::mainutils::essentials::do_cor_test,
    },
    EvaluatedBuiltin {
        name: "var.test",
        handler: crate::mainutils::essentials::do_var_test,
    },
    EvaluatedBuiltin {
        name: "bartlett.test",
        handler: crate::mainutils::essentials::do_bartlett_test,
    },
    EvaluatedBuiltin {
        name: "kruskal.test",
        handler: crate::mainutils::essentials::do_kruskal_test,
    },
    EvaluatedBuiltin {
        name: "fligner.test",
    ...
    EvaluatedBuiltin {
        name: "poisson.test",
        handler: crate::mainutils::essentials::do_poisson_test,
    },
    EvaluatedBuiltin {
        name: "prop.trend.test",
        handler: crate::mainutils::essentials::do_prop_trend_test,
    },
    EvaluatedBuiltin {
        name: "fisher.test",
    ...
    EvaluatedBuiltin {
        name: "quade.test",
        handler: crate::mainutils::essentials::do_quade_test,
    },
    EvaluatedBuiltin {
    ...
    EvaluatedBuiltin {
        ...
        handler: crate::mainutils::essentials::do_confint_default,
    },
    EvaluatedBuiltin {
        name: "vcov",
    ...
    EvaluatedBuiltin {
        name: "nls.control",
        handler: crate::mainutils::essentials::do_nls_control,
    },
    EvaluatedBuiltin {
        name: "SSlogis",
    ...
    EvaluatedBuiltin {
        name: "glm.control",
        handler: crate::mainutils::essentials::do_glm_control,
    },
    EvaluatedBuiltin {
        name: "SSgompertz",
    ...
    EvaluatedBuiltin {
        name: "glm.fit",
        handler: crate::mainutils::essentials::do_glm_fit,
    },
    EvaluatedBuiltin {
        name: "lm",
    ...
    EvaluatedBuiltin {
        name: "se.contrast",
        handler: crate::mainutils::essentials::do_se_contrast,
    },
    EvaluatedBuiltin {
        name: "mauchly.test",
        handler: crate::mainutils::essentials::do_mauchly_test,
    },
    EvaluatedBuiltin {
        name: "SSD",
        handler: crate::mainutils::essentials::do_ssd,
    },
    EvaluatedBuiltin {
        name: "selfStart",
    ...
    EvaluatedBuiltin {
        name: "getInitial",
        handler: crate::mainutils::essentials::do_get_initial,
    },
    EvaluatedBuiltin {
        name: "stat.anova",
    ...
    EvaluatedBuiltin {
        name: "rect.hclust",
        handler: crate::mainutils::essentials::do_rect_hclust,
    },
    EvaluatedBuiltin {
        name: "cutree",
    ...
    EvaluatedBuiltin {
        name: "qbirthday",
        handler: crate::mainutils::essentials::do_qbirthday,
    },
    EvaluatedBuiltin {
        name: "qqnorm",
    ...
    EvaluatedBuiltin {
        name: "lowess",
        handler: crate::library::stats::lowess::do_lowess,
    },
    EvaluatedBuiltin {
        name: "supsmu",
        handler: crate::library::stats::lowess::do_supsmu,
    },
    EvaluatedBuiltin {
        name: "cancor",
    ...
    EvaluatedBuiltin {
        name: "medpolish",
        handler: crate::mainutils::essentials::do_medpolish,
    },
    EvaluatedBuiltin {
        name: "isoreg",
    ...
    EvaluatedBuiltin {
        name: "ksmooth",
        handler: crate::library::stats::ksmooth::do_ksmooth,
    },
    EvaluatedBuiltin {
        name: "line",
    ...
    EvaluatedBuiltin {
        name: "runmed",
        handler: crate::library::stats::srunmed::do_runmed,
    },
    EvaluatedBuiltin {
        name: "stl",
        handler: crate::library::stats::stl::do_stl,
    },
    EvaluatedBuiltin {
        name: "filter",
        handler: crate::library::stats::filter::do_filter,
    },
    EvaluatedBuiltin {
        name: "decompose",
        handler: crate::library::stats::filter::do_decompose,
    },
    EvaluatedBuiltin {
        name: "acf",
        handler: crate::library::stats::filter::do_acf,
    },
    EvaluatedBuiltin {
        name: "spec.ar",
        handler: crate::library::stats::filter::do_spec_ar,
    },
    EvaluatedBuiltin {
        name: "ARMAacf",
        handler: crate::library::stats::filter::do_ARMAacf,
    },
    EvaluatedBuiltin {
        name: "ARMAtoMA",
        handler: crate::library::stats::filter::do_ARMAtoMA,
    },
    EvaluatedBuiltin {
        name: "acf2AR",
    ...
    EvaluatedBuiltin {
        name: "is.mts",
        handler: crate::library::stats::filter::do_is_mts,
    },
    EvaluatedBuiltin {
        name: "is.leaf",
    ...
    EvaluatedBuiltin {
        name: "labels",
        handler: crate::library::stats::filter::do_labels,
    },
    EvaluatedBuiltin {
        name: "na.action",
        handler: crate::library::stats::filter::do_na_action,
    },
    EvaluatedBuiltin {
        name: "model.weights",
        handler: crate::library::stats::filter::do_model_weights,
    },
    EvaluatedBuiltin {
        name: "model.matrix",
    ...
    EvaluatedBuiltin {
        ...
        handler: crate::library::stats::filter::do_model_matrix_lm,
    },
    EvaluatedBuiltin {
        name: "reformulate",
    ...
    EvaluatedBuiltin {
        name: "all.vars",
        handler: crate::library::stats::filter::do_all_vars,
    },
    EvaluatedBuiltin {
    ...
    EvaluatedBuiltin {
        name: "drop.scope",
        handler: crate::library::stats::filter::do_drop_scope,
    },
    EvaluatedBuiltin {
        name: "add.scope",
    ...
    EvaluatedBuiltin {
        name: "step",
        handler: crate::mainutils::essentials::do_step,
    },
    EvaluatedBuiltin {
        name: "all.names",
    ...
    EvaluatedBuiltin {
        name: "qsmirnov",
        handler: crate::mainutils::essentials::do_qsmirnov,
    },
    EvaluatedBuiltin {
        name: "rsmirnov",
    ...
    EvaluatedBuiltin {
        name: "window<-",
        handler: crate::library::stats::filter::do_window_set,
    },
    EvaluatedBuiltin {
        name: "lag",
    ...
    EvaluatedBuiltin {
        name: "pacf",
        handler: crate::library::stats::filter::do_pacf,
    },
    EvaluatedBuiltin {
        name: "shapiro.test",
    ...
    EvaluatedBuiltin {
        name: "ar",
        handler: crate::library::stats::filter::do_ar,
    },
    EvaluatedBuiltin {
        name: "ar.yw",
        handler: crate::library::stats::filter::do_ar,
    ...
    EvaluatedBuiltin {
        name: "ar.mle",
        handler: crate::library::stats::filter::do_ar_mle,
    },
    EvaluatedBuiltin {
        name: "spec.pgram",
    ...
    EvaluatedBuiltin {
        name: "nlminb",
        handler: crate::library::stats::zeroin::do_nlminb,
    },
    EvaluatedBuiltin {
        name: "approx",
    ...
    EvaluatedBuiltin {
        name: "approxfun",
        handler: crate::library::stats::approx::do_approxfun,
    },
    EvaluatedBuiltin {
        name: ".approx_apply",
        handler: crate::library::stats::approx::do_approx_apply,
    },
    EvaluatedBuiltin {
        name: "spline",
    ...
    EvaluatedBuiltin {
        name: "D",
        handler: crate::mainutils::essentials::do_D,
    },
    EvaluatedBuiltin {
        name: "deriv",
        handler: crate::mainutils::essentials::do_deriv,
    },
    EvaluatedBuiltin {
        name: "deriv3",
        handler: crate::mainutils::essentials::do_deriv3,
    },
    EvaluatedBuiltin {
        name: "kronecker",
    ...
    EvaluatedBuiltin {
        name: "as.POSIXlt",
        handler: crate::mainutils::datetime::do_as_POSIXlt,
    },
    EvaluatedBuiltin {
        name: "as.Date.POSIXct",
        handler: crate::mainutils::essentials::do_as_Date,
    },
    EvaluatedBuiltin {
        name: "as.Date.POSIXlt",
        handler: crate::mainutils::essentials::do_as_Date,
    },
    EvaluatedBuiltin {
        name: "format.POSIXlt",
    ...
    EvaluatedBuiltin {
        name: "weekdays.POSIXt",
        handler: crate::mainutils::datetime::do_weekdays_POSIXt,
    },
    EvaluatedBuiltin {
        name: "months.POSIXt",
        handler: crate::mainutils::datetime::do_months_POSIXt,
    },
    EvaluatedBuiltin {
        name: "quarters.POSIXt",
        handler: crate::mainutils::datetime::do_quarters_POSIXt,
    },
    EvaluatedBuiltin {
        name: "as.character.POSIXt",
        handler: crate::mainutils::datetime::do_as_character_POSIXt,
    },
    EvaluatedBuiltin {
        name: "as.character.POSIXlt",
        handler: crate::mainutils::datetime::do_as_character_POSIXt,
    },
    EvaluatedBuiltin {
        name: "as.character.POSIXct",
        handler: crate::mainutils::datetime::do_as_character_POSIXt,
    },
    EvaluatedBuiltin {
    ...
    EvaluatedBuiltin {
        name: "comment",
        handler: crate::mainutils::essentials::do_comment,
    },
    EvaluatedBuiltin {
        name: "structure",
    ...
    EvaluatedBuiltin {
        name: "summary.manova",
        handler: crate::mainutils::essentials::do_summary_manova,
    },
    EvaluatedBuiltin {
        name: "anova",
    ...
    EvaluatedBuiltin {
        name: "mahalanobis",
        handler: crate::mainutils::essentials::do_mahalanobis,
    },
    EvaluatedBuiltin {
        name: "cov.wt",
    ...
    EvaluatedBuiltin {
        name: "addNA",
        handler: crate::mainutils::essentials::do_addNA,
    },
    EvaluatedBuiltin {
        name: "is.factor",
    ...
    EvaluatedBuiltin {
        name: "Sys.which",
        handler: crate::mainutils::essentials::do_Sys_which,
    },
    EvaluatedBuiltin {
        name: "Sys.info",
    ...
    EvaluatedBuiltin {
        name: "tsp",
        handler: crate::mainutils::essentials::do_tsp,
    },
    EvaluatedBuiltin {
        name: "tsp<-",
    ...
    EvaluatedBuiltin {
        name: "regmatches",
        handler: crate::mainutils::essentials::do_regmatches,
    },
    EvaluatedBuiltin {
        name: "regexec",
...
mod tests {
    ...
    fn evaluated_builtin_lookup_covers_core_families() {
        for name in ["+", "log", ".rport_require", "subset", "dnorm", "qgeom"] {
            assert!(
...
#[cfg(test)]
mod wasm_m1_tests {
    use super::EVALUATED_BUILTINS;

    /// Native gate check: all 21 stats/fourier entries stay wired to
    /// their real handlers on native (wasm stubs are wasm-only).
    #[test]
