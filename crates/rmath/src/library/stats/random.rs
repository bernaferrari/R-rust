...
const RAND_CALL_NAMES: &[&str] = &[
    ...
    "C_kmeans_Lloyd", "C_kmeans_MacQueen", "C_Rsm", "C_acf", "C_pacf1", "C_SWilk", "C_nls_iter", "C_tukeyline", "C_pRho", "C_pKendall", "C_ksmooth", "C_rfilter", "C_cfilter", "C_arma0_kfore", "C_psmirnov_exact", "C_rWishart", "C_ar2ma",
