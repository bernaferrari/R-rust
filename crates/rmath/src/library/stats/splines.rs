...
unsafe fn natural_spline(
    ...
    unsafe {
        ...
        *b.add(nm1) =
        ...
        i = 1;
        while i < nm1 {
            *b.add(i) = (*y.add(i + 1) - *y.add(i)) / *d.add(i)
                - *d.add(i) * (*c.add(i + 1) + 2.0 * *c.add(i));
...
unsafe fn periodic_spline(
    ...
    unsafe {
        ...
        if n == 3 {
            ...
            *b.add(2) = val;
            let cv =
                -3.0 * (*y.add(0) - *y.add(1)) / (*x.add(2) - *x.add(1)) / (*x.add(1) - *x.add(0));
            *c.add(0) = cv;
            *c.add(1) = -cv;
            *c.add(2) = cv;
        ...
        *c.add(0) =
        ...
        while i < nm1 {
            ...
            *c.add(i) = (*y.add(i + 1) - *y.add(i)) / *d.add(i)
                - (*y.add(i) - *y.add(i - 1)) / *d.add(i - 1);
            i += 1;
        }
        ...
        *c.add(nm1 - 1) =
            (*c.add(nm1 - 1) - *d.add(nm1 - 2) * *c.add(nm1 - 2) - s) / *b.add(nm1 - 1);
        ...
        *c.add(nm1 - 2) = (*c.add(nm1 - 2) - *d.add(nm1 - 2) * *c.add(nm1 - 1)) / *b.add(nm1 - 2);
        ...
        while i >= 1 {
            *c.add(i) =
                (*c.add(i) - *d.add(i) * *c.add(i + 1) - e[i] * *c.add(nm1 - 1)) / *b.add(i);
            i -= 1;
        }
        if nm1 >= 3 {
            i = nm1 - 3;
