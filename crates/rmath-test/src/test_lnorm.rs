...
pub fn run_tests() -> Result<(), String> {
    ...
    assert_equiv(dlnorm_inner(0.0, 0.0, 0.0, false), 0.0, "dlnorm(0,0,0)");
    ...
    assert_equiv(
        plnorm_inner(0.0, 0.0, 0.0, true, false),
        0.0,
        "plnorm(0,0,0)",
    );
    ...
    assert_equiv(
        qlnorm_inner(0.0, 0.0, 0.0, true, false),
        0.0,
        "qlnorm(0,0,0)",
    );
    ...
    assert_equiv(qlnorm_inner(0.0, 0.0, 1.0, true, false), 0.0, "qlnorm(0)");
    ...
    assert_equiv(rlnorm_inner(0.0, 0.0), 1.0, "rlnorm(0,0)");
