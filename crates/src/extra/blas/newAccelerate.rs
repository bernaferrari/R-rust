// Ported 1:1 from ./r-source/src/extra/blas/newAccelerate.c - original code structure preserved
...
#define Mint(fun) \
pub unsafe fn ACC_NAME(fun)(void); \
pub unsafe fn F77_NAME(fun)(void) { \
    return ACC_NAME(fun)(); \
}
#define Mdouble(fun) \
pub unsafe fn ACC_NAME(fun)(void); \
