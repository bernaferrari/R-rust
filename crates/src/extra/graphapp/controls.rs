// Ported 1:1 from ./r-source/src/extra/graphapp/controls.c - original code structure preserved
 ...
 */
pub unsafe fn setaction(control obj, actionfn fn) {
{
    if (obj)
	obj->action = fn;
}

pub unsafe fn sethit(control obj, intfn fn) {
{
    if (obj)
	obj->hit = fn;
}

pub unsafe fn setdel(control obj, actionfn fn) {
{
    if (obj)
	if (obj->call)
	    obj->call->die = fn;
...
pub unsafe fn setclose(control obj, actionfn fn) {
{
    if (obj)
	if (obj->call)
	    obj->call->close = fn;
...
pub unsafe fn setredraw(control obj, drawfn fn) {
{
    if (obj)
	if (obj->call)
	    obj->call->redraw = fn;
...
pub unsafe fn setresize(control obj, drawfn fn) {
{
    if (obj)
	if (obj->call)
	    obj->call->resize = fn;
...
pub unsafe fn setkeydown(control obj, keyfn fn) {
{
    if (obj)
	if (obj->call)
	    obj->call->keydown = fn;
...
pub unsafe fn setkeyaction(control obj, keyfn fn) {
{
    if (obj)
	if (obj->call)
...
pub unsafe fn setmousedown(control obj, mousefn fn) {
{
    if (obj)
	if (obj->call)
...
pub unsafe fn setmouseup(control obj, mousefn fn) {
{
    if (obj)
	if (obj->call)
	    obj->call->mouseup = fn;
...
pub unsafe fn setmousemove(control obj, mousefn fn) {
{
    if (obj)
	if (obj->call)
...
pub unsafe fn setmousedrag(control obj, mousefn fn) {
{
    if (obj)
	if (obj->call)
...
pub unsafe fn setmouserepeat(control obj, mousefn fn) {
{
    if (obj)
	if (obj->call)
...
pub unsafe fn setdrop(control obj, dropfn fn) {
{
    if (obj)
	if (obj->call) {
...
pub unsafe fn setonfocus(control obj, actionfn fn) {
{
    if (obj)
	obj->call->focus = fn;
}

pub unsafe fn setim(control obj, imfn fn) {
{
    if (obj)
	obj->call->im = fn;
}
 ...
 */
pub unsafe fn clear(control obj) {
{
    drawing prev;
    rgb old;
...
pub unsafe fn draw(control obj) {
{
    drawing prev;
    drawstate old = NULL;
...
pub unsafe fn redraw(control obj) {
{
    clear(obj);
    draw(obj);
}

/*  pub unsafe fn getscreenrect(control obj, rect *r) */
/*  { */
/*      RECT W; */
...
*/
pub unsafe fn resize(control obj, rect r) {
{
    RECT R;
    WINDOWPLACEMENT W;
    int dw, dh, dx, dy;
 ...
 */
pub unsafe fn show(control obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
...
pub unsafe fn hide(control obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
...
pub unsafe fn isvisible(control obj) -> c_int {
{
    if (! obj)
	return 0;
 ...
 */
pub unsafe fn enable(control obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
...
pub unsafe fn disable(control obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
...
pub unsafe fn isenabled(control obj) -> c_int {
{
    if (! obj)
	return 0;
 ...
 */
pub unsafe fn check(control obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
...
pub unsafe fn uncheck(control obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
...
pub unsafe fn ischecked(control obj) -> c_int {
{
    if (! obj)
	return 0;
 ...
 */
pub unsafe fn highlight(control obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
...
pub unsafe fn unhighlight(control obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
...
pub unsafe fn ishighlighted(control obj) -> c_int {
{
    if (! obj)
	return 0;
 ...
 */
pub unsafe fn flashcontrol(control obj) {
{
    highlight(obj);
    delay(150);
    unhighlight(obj);
 ...
 */
pub unsafe fn activatecontrol(control obj) {
{
    if (! obj)
	return;
    drawto(obj);
 ...
 */
#if 0
pub unsafe fn setstate(control obj, long state) {
{
    if (obj)
	obj->state = state;
}
...
pub unsafe fn setvalue(control obj, int value) {
{
    if (obj)
	obj->value = value;
}

pub unsafe fn getvalue(control obj) -> c_int {
{
    if (obj)
	return obj->value;
    else
...
pub unsafe fn setforeground(control obj, rgb fg) {
{
    if (! obj)
	return;
    obj->fg = fg;
...
pub unsafe fn setbackground(control obj, rgb bg) {
{
...
pub unsafe fn setdata(control obj, pub unsafe fn *data) {
{
    if (obj)
	obj->data = data;
}
...
#ifdef UNUSED
pub unsafe fn _setextradata(control obj, pub unsafe fn *data) {
{
    if (obj)
	obj->extra = data;
}
 ...
 */
pub unsafe fn settext(control obj, const char *text) {
{
    char *old_text;
 ...
 */
pub unsafe fn settextfont(object obj, font f) {
{
    if (! obj)
	return;
    if (! f)
...
pub unsafe fn objwidth(object obj) -> c_int {
{
    rect r = objrect(obj);
    return r.width;
}

pub unsafe fn objheight(object obj) -> c_int {
{
    rect r = objrect(obj);
    return r.height;
}

pub unsafe fn objdepth(object obj) -> c_int {
{
    HDC screendc;
    int depth;
...
pub unsafe fn delobj(object obj) {
{
    if (! obj)
	return;
    switch (obj->kind)
...
pub unsafe fn setcaret(object obj, int x, int y, int width, int height) {
{
    if (! obj)
    	return;
...
pub unsafe fn showcaret(object obj, int showing) {
{
