// Ported 1:1 from ./r-source/src/extra/graphapp/gbuttons.c - original code structure preserved
...
pub unsafe fn gsetcursor(drawing d, cursor c) {
{
    POINT pt;
...
pub unsafe fn scrolltext(textbox c, int lines) {
{
...
pub unsafe fn ggetkeystate(void) -> c_int {
{
    int k = 0;
...
pub unsafe fn scrollcaret(textbox t, int lines) {
{
...
pub unsafe fn gsetmodified(textbox t, int modified) {
{
    sendmessage(t->handle, EM_SETMODIFY, (WPARAM) modified, 0);
}

pub unsafe fn ggetmodified(textbox t) -> c_int {
{
...
pub unsafe fn getlinelength(textbox t) -> c_int {
{
...
pub unsafe fn getcurrentline(textbox t, char *line, int length) {
{
...
pub unsafe fn getseltext(textbox t, char *text) {
{
...
pub unsafe fn setlimittext(textbox t, long limit) {
{
...
pub unsafe fn checklimittext(textbox t, long n) {
{
...
pub unsafe fn textselectionex(control obj, long *start, long *end) {
{
    CHARRANGE sel;
    if (! obj)
	return;
...
pub unsafe fn selecttextex(control obj, long start, long end) {
{
    CHARRANGE sel;
    long length;
