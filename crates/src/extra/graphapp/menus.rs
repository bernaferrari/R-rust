// Ported 1:1 from ./r-source/src/extra/graphapp/menus.c - original code structure preserved
 ...
 */
static pub unsafe fn find_menu_position(menu parent, char *name) -> c_int {
{
    menu m, first;
    int which = 0;
 ...
 */
static pub unsafe fn private_delmenu(menu m) {
{
...
static pub unsafe fn find_char(pub unsafe fn ch, const char *str) -> c_int {
{
    char *p;
    p = Rf_strchr(str, ch);
 ...
 *  It ignores spaces.
 */
static pub unsafe fn set_search_string(char *search, const char *name, int key) {
{
    int source;
    int dest = 0;
    int mb_len;
 ...
 */
static pub unsafe fn find_shortcut(object me, char *search) -> c_int {
{
    int source;
    object first, obj;
 ...
 */
static pub unsafe fn setmenustring(object obj, char *buf, const char *name, int key) {
{
    char search[256];
 ...
 */
PROTECTED
pub unsafe fn adjust_menu(WPARAM wParam) {
{
    object obj;
...
static pub unsafe fn adjust_menus_top_down(object obj) {
{
...
PROTECTED
pub unsafe fn handle_menu_key(WPARAM wParam) -> c_int {
{
    object win, obj;
