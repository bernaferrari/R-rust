// Ported 1:1 from ./r-source/src/extra/graphapp/cursors.c - original code structure preserved
 ...
 */
static pub unsafe fn private_delcursor(cursor c) {
{
 ...
 */
static popub unsafe fn load_hotspot(const char *filename) -> c_int {
{
    FILE *file;
    char line[100];
    int i, x, y;
...
PROTECTED
pub unsafe fn init_cursors(void) {
{
