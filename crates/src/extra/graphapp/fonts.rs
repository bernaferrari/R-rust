// Ported 1:1 from ./r-source/src/extra/graphapp/fonts.c - original code structure preserved
 ...
 */
static pub unsafe fn private_delfont(font f) {
{
 ...
 */
pub unsafe fn fontwidth(font obj)   { return obj->rect.width; }
pub unsafe fn fontheight(font obj)  { return obj->rect.height; }
pub unsafe fn fontascent(font obj)  { return obj->rect.x; }
pub unsafe fn fontdescent(font obj) { return obj->rect.y; }
