// Ported 1:1 from ./r-source/src/extra/graphapp/tooltips.c - original code structure preserved
...
/*
 *  Support for tooltip
 *  pub unsafe fn addtooltip(obj,char *) (on error return 0) -> c_int {
 */
...
pub unsafe fn addtooltip(control c, const char *tp) -> c_int {
{
    TOOLINFO ti;
    char *cc = (char*) &ti;
    int i, lim = sizeof (ti);
