// Ported 1:1 from ./r-source/src/extra/graphapp/context.c - original code structure preserved
 ...
 */
static pub unsafe fn create_pen_and_brush(rgb c, unsigned long winrgb,
		int width, int depth)
{
 ...
 */
static pub unsafe fn delete_pen_and_brush(void) {
{
 ...
 */
PROTECTED
pub unsafe fn init_contexts(void) {
{
...
static pub unsafe fn free_context(contextinfo *c) {
{
    if (! c->dc)
 ...
 */
PROTECTED
pub unsafe fn add_context(object obj, HDC dc, HGDIOBJ old) {
{
    contextinfo *c;
 ...
 */
PROTECTED
pub unsafe fn remove_context(object obj) {
{
    int i;
    contextinfo *c;
 ...
 */
PROTECTED
pub unsafe fn del_context(object obj) {
{
    int i;
    contextinfo *c;
 ...
 */
PROTECTED
pub unsafe fn del_all_contexts(void) {
{
    int i;
    contextinfo *c;
 ...
 */
PROTECTED
pub unsafe fn finish_contexts(void) {
{
    del_all_contexts();
    DeleteObject(the_pen);
    DeleteObject(the_brush);
...
pub unsafe fn setcursor(cursor c) {
{
 ...
 *  when drawing.
 */
pub unsafe fn setdrawmode(int mode) {
{
 ...
 *  Set the line width.
 */
pub unsafe fn setlinewidth(int width) {
{
    if (width < 1)
	width = 1;
 ...
 */
pub unsafe fn addto(object obj) {
{
    if (! obj)
	return;
    switch (obj->kind) {
 ...
 */
pub unsafe fn drawto(drawing d) {
{
    if (! d) {
	current = & app_drawstate;
	current->dest = NULL;
 ...
 */
pub unsafe fn setdrawstate(drawstate s) {
{
    if (! s)
	return;
    moveto(s->p);
 ...
 */
pub unsafe fn restoredrawstate(drawstate s) {
{
    if (! s)
	return;
    setdrawstate(s);
 ...
 */
pub unsafe fn resetdrawstate(void) {
{
    setrgb(Black);
    setlinewidth(1);
