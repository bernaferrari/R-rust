// Ported 1:1 from ./r-source/src/extra/graphapp/buttons.c - original code structure preserved
 ...
 */
static pub unsafe fn ensure_window(void) {
{
    if (! current_window) {
 ...
 */
static pub unsafe fn set_new_winproc(object obj) {
{
    HWND hwnd;
    hwnd = obj->handle;
#ifdef _WIN64
 ...
 */
static pub unsafe fn private_delcontrol(control obj) {
{
 ...
 */
static pub unsafe fn draw_label(control c, rect r) {
{
    /* Draw the label. */
    if (!isenabled(c))
	setcolour(Grey);
 ...
 *  siblings.
 */
static pub unsafe fn uncheck_neighbours(object obj) {
{
 ...
 */
static pub unsafe fn draw_shadow(rect r, rgb col1, rgb col2, int size) {
{
    rgb hue = current->hue;
 ...
 */
static pub unsafe fn button_mousedown(control c, int buttons, point xy) {
{
    arm(c);
    highlight(c);
}

static pub unsafe fn button_mousemove(control c, int buttons, point xy) {
{
    if (!isarmed(c))
	return;
...
static pub unsafe fn button_mouseup(control c, int buttons, point xy) {
{
    if (!isarmed(c))
	return;
    disarm(c);
...
static pub unsafe fn button_keydown(control c, int ch) {
{
    if (ch == ' ') {
	flashcontrol(c);
	activatecontrol(c);
 ...
 */
static pub unsafe fn checkbox_mousedown(control c, int buttons, point xy) {
{
    arm(c);
    highlight(c);
}

static pub unsafe fn checkbox_mousemove(control c, int buttons, point xy) {
{
    if (!isarmed(c))
	return;
    if (buttons && ptinr(xy,getrect(c)))
...
static pub unsafe fn checkbox_mouseup(control c, int buttons, point xy) {
{
    if (! isenabled(c))
	return;
    disarm(c);
...
static pub unsafe fn checkbox_keydown(control c, int ch) {
{
    if (ch == ' ') {
	if (ischecked(c))
	    uncheck(c);
...
pub unsafe fn setimage(control obj, image img) {
{
...
static pub unsafe fn draw_image_button(button obj, rect r) {
{
    image   img;
    bitmap	store = NULL;
    rect    ir;
...
static pub unsafe fn draw_picture(control obj, rect r) {
{
    image   img;
    bitmap	store = NULL;
    rgb     old = currentcolour();
...
#else
static pub unsafe fn draw_button(control c, rect r) {
{
    rect textrect;
    rgb up, down;
    font f;
...
#else
static pub unsafe fn draw_checkmark(rect r) {
{
    int len;
...
static pub unsafe fn draw_checkbox(control c, rect r) {
{
    int w;
    rect box, textrect;
    char *name;
...
static pub unsafe fn draw_radio(control c, rect r) {
{
    int w;
    rect box, textrect;
    char *name;
...
static pub unsafe fn radio_hit(control c) {
{
    if (!ischecked(c)) {
...
static pub unsafe fn radio_mouseup(control c, int buttons, point xy) {
{
    if (! isarmed(c))
	return;
    disarm(c);
...
static pub unsafe fn radio_keydown(control c, int ch) {
{
    if (ch == ' ')
	radio_hit(c);
}
...
pub unsafe fn undotext(control obj)  /* Why was this previously commented out? CJ */
{
    if (! obj)
	return;
...
pub unsafe fn cuttext(control obj) {
{
    if (! obj)
	return;
    if ((obj->kind != FieldObject) && (obj->kind != TextboxObject))
...
pub unsafe fn copytext(control obj) {
{
    if (! obj)
	return;
    if ((obj->kind != FieldObject) && (obj->kind != TextboxObject))
...
pub unsafe fn cleartext(control obj) {
{
    if (! obj)
	return;
    if ((obj->kind != FieldObject) && (obj->kind != TextboxObject))
...
pub unsafe fn pastetext(control obj) {
{
    if (! obj)
	return;
    if ((obj->kind != FieldObject) && (obj->kind != TextboxObject))
...
pub unsafe fn inserttext(control obj, const char *text) {
{
    if (! obj)
	return;
    if ((obj->kind != FieldObject) && (obj->kind != TextboxObject))
...
pub unsafe fn selecttext(control obj, long start, long end) {
{
    int left, right;
    long length;
...
pub unsafe fn textselection(control obj, long *start, long *end) {
{
    unsigned long sel;
...
pub unsafe fn changescrollbar(scrollbar obj, int where, int max, int pagesize) {
{
    HWND hwnd;
...
pub unsafe fn setlistitem(listbox obj, int index) {
{
    int count;
...
pub unsafe fn isselected(listbox obj, pub unsafe fn index) -> c_int {
{
    if (! obj)
	return -1;
    switch (obj->kind)
...
pub unsafe fn getlistitem(listbox obj) -> c_int {
{
    int index, count;
...
pub unsafe fn changelistbox(listbox obj, const char **list) {
{
    int i;
    HWND hwnd;
 ...
 */
PROTECTED
pub unsafe fn handle_control(HWND hwnd, UINT message) {
{
    object obj;
    int index;
...
pub unsafe fn setprogressbar(progressbar obj, int n) {
{
    if (! obj) return;
    sendmessage(obj->handle, PBM_SETPOS, (WPARAM) n, 0);
}

pub unsafe fn stepprogressbar(progressbar obj, int n) {
{
    if (! obj) return;
    sendmessage(obj->handle, PBM_STEPIT, 0, 0);
}

pub unsafe fn setprogressbarrange(progressbar obj, int pbmin, int pbmax) {
{
    if (! obj) return;
