// Ported 1:1 from ./r-source/src/extra/graphapp/printer.c - original code structure preserved
 ...
 */
static pub unsafe fn private_delprinter(printer obj) {
{
...
pub unsafe fn nextpage(printer p) {
{
