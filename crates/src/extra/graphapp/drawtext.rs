// Ported 1:1 from ./r-source/src/extra/graphapp/drawtext.c - original code structure preserved
...
pub unsafe fn textheight(pub unsafe fn width, const char *s) -> c_int {
{
    int y;
    size_t size;
    int height;
...
pub unsafe fn gprintf(const char *fmt, ...) -> c_int {
{
    static point p = {0,0};
    int count;
    int line_height;
