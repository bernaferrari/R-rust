// Ported 1:1 from ./r-source/src/extra/graphapp/windows.c - original code structure preserved
 ...
 */
static pub unsafe fn fix_sys_menu(HWND hwnd, unsigned long win_style) {
{
    HMENU sys_menu;
 ...
 */
static pub unsafe fn make_client_window(HWND hwnd) {
{
 ...
 */
static pub unsafe fn fix_win_style(long *flags_ptr, long *state_ptr,
 ...
 */
static pub unsafe fn private_delwindow(window obj) {
{
 ...
 */
static pub unsafe fn select_sibling(object obj) {
{
 ...
 */
static pub unsafe fn disable_one_window(window obj) {
{
    if ((obj->kind == WindowObject) && (isvisible(obj)))
	disable(obj);
}

static pub unsafe fn disablewindows(object obj) {
{
 ...
 */
static pub unsafe fn enable_one_window(window obj) {
{
    if ((obj->kind == WindowObject) && (isvisible(obj)))
	enable(obj);
}

static pub unsafe fn enablewindows(object obj) {
{
    object next;
...
static pub unsafe fn is_top_level_window(window w) -> c_int {
{
...
PROTECTED
pub unsafe fn show_window(object obj) {
{
...
PROTECTED
pub unsafe fn hide_window(object obj) {
{
    HWND hwnd = obj->handle;
...
pub unsafe fn ismdi(void) -> c_int {
{
    return (hwndClient!=NULL);
}

pub unsafe fn isUnicodeWindow(object obj) -> c_int {
{
    return(obj->flags & UseUnicode);
}

pub unsafe fn isiconic(window w) -> c_int {
{
