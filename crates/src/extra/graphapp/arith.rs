// Ported 1:1 from ./r-source/src/extra/graphapp/arith.c - original code structure preserved
...
popub unsafe fn newpoint(pub unsafe fn x, pub unsafe fn y) -> c_int {
{
    point p;
...
popub unsafe fn topleft(rect r) -> c_int {
{
    point p;
...
popub unsafe fn topright(rect r) -> c_int {
{
    point p;
...
popub unsafe fn bottomright(rect r) -> c_int {
{
    point p;
...
popub unsafe fn bottomleft(rect r) -> c_int {
{
	point p;
...
popub unsafe fn addpt(popub unsafe fn p1, popub unsafe fn p2) -> c_int {
{
    p1.x += p2.x;
    p1.y += p2.y;
    return p1;
...
popub unsafe fn subpt(popub unsafe fn p1, popub unsafe fn p2) -> c_int {
{
    p1.x -= p2.x;
    p1.y -= p2.y;
    return p1;
...
popub unsafe fn midpt(popub unsafe fn p1, popub unsafe fn p2) -> c_int {
{
    point p;
...
popub unsafe fn mulpt(popub unsafe fn p, pub unsafe fn i) -> c_int {
{
    p.x *= i;
    p.y *= i;
    return p;
...
popub unsafe fn divpt(popub unsafe fn p, pub unsafe fn i) -> c_int {
{
    p.x /= i;
    p.y /= i;
    return p;
...
pub unsafe fn ptinr(popub unsafe fn p, rect r) -> c_int {
{
...
pub unsafe fn rinr(rect r1, rect r2) -> c_int {
{
...
pub unsafe fn rxr(rect r1, rect r2) -> c_int {
{
...
pub unsafe fn equalpt(popub unsafe fn p1, popub unsafe fn p2) -> c_int {
{
...
pub unsafe fn equalr(rect r1, rect r2) -> c_int {
{
