// Ported 1:1 from ./r-source/src/extra/graphapp/events.c - original code structure preserved
 ...
 */
static pub unsafe fn handle_mouse(object obj, HWND hwnd, UINT message,
 ...
 *  with a window.
 */
static pub unsafe fn handle_virtual_keydown(object obj, int param) {
{
...
static pub unsafe fn handle_keydown(int param) {
{
    if (param == VK_SHIFT)
	keystate |= ShiftKey;
...
static pub unsafe fn handle_keyup(int param) {
{
    if (param == VK_SHIFT)
	keystate &= ~ShiftKey;
    else if (param == VK_CONTROL)
 ...
 */
static pub unsafe fn handle_char(object obj, int ch) {
{
...
pub unsafe fn toolbar_show(void) {
{
    showMDIToolbar = 1;
    sendmessage(hwndFrame,WM_PAINT, (WPARAM) 0, (LPARAM) 0);
}
pub unsafe fn toolbar_hide(void) {
{
    showMDIToolbar = 0;
    sendmessage(hwndFrame,WM_PAINT, (WPARAM) 0, (LPARAM) 0);
}

static pub unsafe fn handle_mdiframesize(void) {
{
 ...
 */
static pub unsafe fn handle_resize(object obj) {
{
 ...
 */
static pub unsafe fn handle_redraw(object obj, HWND hwnd) {
{
    PAINTSTRUCT ps;
    if (obj==MDIFrame)
	handle_mdiframesize();
 ...
 */
static pub unsafe fn handle_close(object obj) {
{
...
static pub unsafe fn handle_destroy(object obj) {
{
    /*
      drawto(obj);
      del_object(obj);
...
static pub unsafe fn handle_focus(object obj, int gained_focus) {
{
    if (gained_focus) {
	obj->state |= GA_Focus;
 ...
 *  scrollbars.
 */
static pub unsafe fn handle_scroll(object obj, HWND hwnd, UINT message,
 ...
 */
  ...
  #ifdef WM_CTLCOLOR
static pub unsafe fn handle_colour(HDC dc, object obj) {
{
    rgb fg, bg;
    COLORREF wincolour;
...
static pub unsafe fn handle_drop(object obj, HANDLE dropstruct) {
{
...
static pub unsafe fn handle_context_menu(object obj, HWND hwnd, int x, int y) {
{
    menu m = obj->popup;
    HWND hw = hwnd;
    POINT wp;
...
pub unsafe fn Rf_unprotect(int);
pub unsafe fn R_ContinueUnwind(SEXP cont);
extern LibImport SEXP R_NilValue;

static SEXP wndproc_cont_token;

static pub unsafe fn wndproc_rethrow_error(void) {
{
...
pub unsafe fn wndproc_unwind_clean(pub unsafe fn *data, Rboolean jump) {
{
    if (jump) 
...
static pub unsafe fn send_char(object obj, int ch) {
{
    while (obj) {
	if ((obj->call) && (obj->call->keydown))
	    break;
 ...
 */
pub unsafe fn settimerfn(timerfn timeout, pub unsafe fn *data) {
{
    do_timer = timeout;
    timer_data = data;
}
 ...
 */
pub unsafe fn settimer(unsigned msec) -> c_int {
{
    if (timer_id != 0) {
 ...
 */
pub unsafe fn setmousetimer(unsigned msec) -> c_int {
{
    if (mouse_timer_id != 0) {
 ...
 */
pub unsafe fn delay(unsigned msec) {
{
    unsigned long now;
    unsigned long stop;
 ...
 */
static pub unsafe fn TranslateMenuKeys(MSG *msg) -> c_int {
{
 ...
 */
pub unsafe fn peekevent(void) -> c_int {
{
 ...
 *  Handle one event.
 */
pub unsafe fn doevent(void) -> c_int {
{
 ...
 */
PROTECTED
pub unsafe fn init_events(void) {
{
 ...
 */
PROTECTED
pub unsafe fn finish_events(void) {
{
    settimer(0);
    setmousetimer(0);
}
