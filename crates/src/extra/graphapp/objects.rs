// Ported 1:1 from ./r-source/src/extra/graphapp/objects.c - original code structure preserved
 ...
 */
PROTECTED
pub unsafe fn init_objects(void) {
{
    if (base_object)
	return;
...
static pub unsafe fn add_object(object obj, object parent) {
{
...
static pub unsafe fn remove_object(object obj) {
{
 ...
 */
PROTECTED
pub unsafe fn move_to_front(object obj) {
{
 ...
 */
pub unsafe fn apply_to_list(object first, actionfn fn) {
{
 ...
 */
PROTECTED
pub unsafe fn decrease_refcount(object obj) {
{
    delnode *new_node;
 ...
 */
PROTECTED
pub unsafe fn increase_refcount(object obj) {
{
 ...
 */
PROTECTED
pub unsafe fn protect_object(object obj) {
{
    if (obj)
	obj->refcount = -1;
}
 ...
 */
static pub unsafe fn remove_delnode(delnode *n) {
{
 ...
 */
static pub unsafe fn remove_deleted_object(object obj) {
{
    delnode *last;
    delnode *next;
    delnode *n;
 ...
 */
static pub unsafe fn del_object(object obj);	/* declaration */
PROTECTED
pub unsafe fn deletion_traversal(void) {
{
    static int level = 0;
    object obj;
 ...
 */
static pub unsafe fn update_app_globals(object obj) {
{
 ...
 */
static pub unsafe fn free_private(object obj) {
{
#if DEBUG
    print_object_list();
#endif
...
static pub unsafe fn free_object(object obj) {
{
    free_private(obj);
 ...
 */
static pub unsafe fn del_object(object obj) {
{
    while (obj->child)
 ...
 */
static pub unsafe fn free_memory(object obj) {
{
...
PROTECTED
pub unsafe fn finish_objects(void) {
{
 ...
 */
#if DEBUG
static pub unsafe fn print_drawstate(FILE *f, drawstate d, object obj) {
{
...
static pub unsafe fn print_objects(FILE *f, object obj, int indent) {
{
    object child;
    char *s;
    int i;
...
PROTECTED
pub unsafe fn print_object_list(void) {
{
...
pub unsafe fn remove_menu_item(object obj) {
{
