// Ported 1:1 from ./r-source/src/extra/graphapp/bitmaps.c - original code structure preserved
 ...
 */
static pub unsafe fn private_delbitmap(bitmap obj) {
{
    if (obj->handle)
 ...
 */
PROTECTED
pub unsafe fn has_transparent_pixels(image img) -> c_int {
{
...
pub unsafe fn setbitmapdata(bitmap obj, unsigned char *data) {
{
    rect r;
...
pub unsafe fn getbitmapdata(bitmap obj, unsigned char *data) {
{
    rect r;
    int depth, size, row_bytes;
    int x, y;
...
pub unsafe fn getbitmapdata2(bitmap obj, unsigned char **data) {
{
    rect r = obj->rect;
