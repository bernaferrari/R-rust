// Ported 1:1 from ./r-source/src/extra/graphapp/strings.c - original code structure preserved
...
pub unsafe fn del_string(const char *str) {
{
    discard(str);
}
 ...
 */
pub unsafe fn copy_string(char *dest, const char *src) {
{
    int len;
    if ((dest) && (src)) {
 ...
 */
pub unsafe fn compare_strings(const char *s1, const char *s2) -> c_int {
{
    int len, diff;
 ...
 */
PROTECTED
pub unsafe fn string_diff(const char *s, const char *t) -> c_int {
{
    int ch1, ch2;
    int diff = 0;
