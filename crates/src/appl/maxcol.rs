// Ported 1:1 from ./r-source/src/appl/maxcol.c - original code structure preserved
...
pub unsafe fn R_max_col(double *matrix, int *nr, int *nc, int *maxes, int *ties_meth) {
{
    int	 c, m;
