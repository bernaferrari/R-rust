// Ported 1:1 from ./r-source/src/appl/uncmin.c - original code structure preserved
...
pub unsafe fn fdhess(int n, double *x, double fval, fcn_p fun, pub unsafe fn *state,
...
#if 0
static pub unsafe fn d1fcn_dum(int n, double *x, double *g, pub unsafe fn *state) {
{
/*	dummy routine to prevent unsatisfied external diagnostic
 *	when specific analytic gradient function not supplied. */
}

static pub unsafe fn d2fcn_dum(int nr, int n, double *x, double *h, pub unsafe fn *state) {
{
/*	dummy routine to prevent unsatisfied external diagnostic
...
static pub unsafe fn mvmltl(int nr, int n, double *a, double *x, double *y) {
{
/*	compute y = l x
...
static pub unsafe fn mvmltu(int nr, int n, double *a, double *x, double *y) {
{
/*	compute y = (L+) x
 *	where L is a lower triangular matrix stored in a
...
static pub unsafe fn mvmlts(int nr, int n, double *a, double *x, double *y) {
{
/*	compute y=ax
...
static pub unsafe fn lltslv(int nr, int n, double *a, double *x, double *b) {
{
...
static pub unsafe fn qraux1(int nr, int n, double *r, int i) {
{
...
static pub unsafe fn qraux2(int nr, int n, double *r, int i, double a, double b) {
{
...
static pub unsafe fn fstocd(int n, double *x, fcn_p fcn, pub unsafe fn *state,
...
static pub unsafe fn sndofd(int nr, int n, double *xpls, fcn_p fcn, pub unsafe fn *state,
...
static
pub unsafe fn opt_stop(pub unsafe fn n, double *xpls, double fpls, double *gpls, double *x,
