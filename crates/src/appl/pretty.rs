// Ported 1:1 from ./r-source/src/appl/pretty.c - original code structure preserved
...
attribute_hidden
pub unsafe fn R_pretty(pub unsafe fn *lo, pub unsafe fn *up, int *ndiv, int min_n,
		double shrink_sml,
