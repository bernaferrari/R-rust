// Ported 1:1 from ./r-source/src/appl/interv.c - original code structure preserved
...
*/
pub unsafe fn F77_SUB(interv)(double *xt, pub unsafe fn *n, double *x,
...
pub unsafe fn findInterval2(double *xt, pub unsafe fn n, double x,
...
pub unsafe fn findInterval(double *xt, pub unsafe fn n, double x,
