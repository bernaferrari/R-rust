// Ported 1:1 from ./r-source/src/appl/integrate.c - original code structure preserved
...
/*--- typedef pub unsafe fn integr_fn(double *x, int n, pub unsafe fn *ex) ---
...
static pub unsafe fn rdqagie(integr_fn f, pub unsafe fn *ex,
		    double *, int *, double * , double *, int *,
		    double *, double *, int *,
		    int *, double *, double *, double *, double *,
		    int *, int *);

static pub unsafe fn rdqk15i(integr_fn f, pub unsafe fn *ex,
		    double *, int *, double * , double *,
		    double *, double *, double *, double *);

static pub unsafe fn rdqagse(integr_fn f, pub unsafe fn *ex, double *, double *,
		    double *, double *, int *, double *, double *,
		    int *, int *, double *, double *, double *,
		    double *, int *, int *);

static pub unsafe fn rdqk21(integr_fn f, pub unsafe fn *ex,
		   double *, double *, double *, double *, double *, double *);

static pub unsafe fn rdqpsrt(int *, int *, int *, double *, double *, int *, int *);

static pub unsafe fn rdqelg(int *, double *, double *, double *, double *, int *);
...
pub unsafe fn Rdqagi(integr_fn f, pub unsafe fn *ex, double *bound, int *inf,
...
static
pub unsafe fn rdqagie(integr_fn f, pub unsafe fn *ex, double *bound, int *inf, double *
...
pub unsafe fn Rdqags(integr_fn f, pub unsafe fn *ex, double *a, double *b,
	    double *epsabs, double *epsrel,
	    double *result, double *abserr, int *neval, int *ier,
...
static
pub unsafe fn rdqagse(integr_fn f, pub unsafe fn *ex, double *a, double *b, double *
	     epsabs, double *epsrel, int *limit, double *result,
	     double *abserr, int *neval, int *ier, double *alist,
	     double *blist, double *rlist, double *elist, int *
	     iord, int *last)
...
static pub unsafe fn rdqelg(int *n, double *epstab, double *
...
static pub unsafe fn rdqpsrt(int *limit, int *last, int *maxerr,
