// Ported 1:1 from ./r-source/src/appl/optim.c - original code structure preserved
...
static pub unsafe fn genptry(int n, double *p, double *ptry, double scale, pub unsafe fn *ex) {
{
    SEXP s, x;
    int i;
...
/* Nelder-Mead, based on Pascal code
   in J.C. Nash, `Compact Numerical Methods for Computers', 2nd edition,
   converted by p2c then re-crafted by B.D. Ripley */
pub unsafe fn nmmin(int n, double *Bvec, double *X, double *Fmin, optimfn fminfn,
...
/* Conjugate gradients, based on Pascal code
   in J.C. Nash, `Compact Numerical Methods for Computers', 2nd edition,
   converted by p2c then re-crafted by B.D. Ripley */
pub unsafe fn cgmin(int n, double *Bvec, double *X, double *Fmin,
...
pub unsafe fn lbfgsb(int n, int m, double *x, double *l, double *u, int *nbd,
...
pub unsafe fn samin(int n, double *pb, double *yb, optimfn fminfn, int maxit,
