// Ported 1:1 from ./r-source/src/appl/lbfgsb.c - original code structure preserved
...
static pub unsafe fn active(int, double *, double *, int *, double *, int *,
		   int, int *, int *, int *);
static pub unsafe fn bmv(int, double *, double *, int *, double *, double *, int *);
static pub unsafe fn cauchy(int, double *, double *,
		   double *, int *, double *, int *, int *,
		   double *, double *, double *, int, double *,
		   double *, double *, double *, double *, int * ,
		   int *, double *, double *, double *, double *,
		   int *, int, double *, int *, double *);
static pub unsafe fn cmprlb(int, int, double *,
		   double *, double *, double *, double *,
		   double *, double *, double *, double *, int *,
		   double *, int *, int *, int *, int *,
		   int *);
static pub unsafe fn dcsrch(double *, double *, double *,
		   double, double, double,
		   double, double, char *);
static pub unsafe fn dcstep(double *, double *,
		   double *, double *, double *, double *,
		   double *, double *, double *, int *, double *,
		   double *);
static pub unsafe fn errclb(int, int, double,
		   double *, double *, int *, char *, int *, int *);
static pub unsafe fn formk(int, int *, int *, int *, int *, int *, int *,
		  int *, double *, double *, int, double *,
		  double *, double *, double *, int *, int *, int *);
static pub unsafe fn formt(int, double *, double *,
		  double *, int *, double *, int *);
static pub unsafe fn freev(int, int *, int *,
		  int *, int *, int *, int *, int *, int *,
		  int *, int, int *);
static pub unsafe fn hpsolb(int, double *, int *, int);
static pub unsafe fn lnsrlb(int, double *, double *,
		   int *, double *, double *, double *, double *,
		   double *, double *, double *, double *,
		   double *, double *, double *, double *,
		   ...
		   char *);
static pub unsafe fn mainlb(int, int, double *,
		   ...
		   int, char *, int *);
static pub unsafe fn matupd(int, int, double *, double *, double *,
		   double *, double *, double *, int *, int *,
		   int *, int *, double *, double *, double *,
		   double *, double *);
static pub unsafe fn projgr(int, double *, double *,
		   int *, double *, double *, double *);
static pub unsafe fn subsm(int, int, int *, int *, double *, double *,
		  int *, double *, double *, double *, double *,
		  double *, int *, int *, int *, double *,
		  double *, int, int *);

static pub unsafe fn prn1lb(int n, int m, double *l, double *u, double *x,
		   int iprint, double epsmch);
static pub unsafe fn prn2lb(int n, double *x, double *f, double *g, int iprint,
		   int iter, int nfgv, int nact, double sbgnrm,
		   int nint, char *word, int iword, int iback,
		   double stp, double xstep);
static pub unsafe fn prn3lb(int n, double *x, double *f, char *task, int iprint,
...
static
pub unsafe fn setulb(int n, int m, double *x, double *l, double *u, int *nbd,
...
static pub unsafe fn mainlb(int n, int m, double *x,
...
static pub unsafe fn active(int n, double *l, double *u,
...
static pub unsafe fn bmv(int m, double *sy, double *wt,
...
static pub unsafe fn cauchy(int n, double *x, double *l, double *u, int *nbd,
...
static pub unsafe fn cmprlb(int n, int m, double *x,
...
static pub unsafe fn errclb(int n, int m, double factr, double *l, double *u,
...
static pub unsafe fn formk(int n, int *nsub, int *ind, int * nenter, int *ileave,
...
static pub unsafe fn formt(int m, double *wt, double *sy, double *ss,
...
static pub unsafe fn freev(int n, int *nfree, int *indx,
...
static pub unsafe fn hpsolb(int n, double *t, int *iorder, int iheap) {
{
/*	************
...
static pub unsafe fn lnsrlb(int n, double *l, double *u,
...
static pub unsafe fn matupd(int n, int m, double *ws,
...
static pub unsafe fn projgr(int n, double *l, double *u,
...
static pub unsafe fn subsm(int n, int m, int *nsub, int *ind,
...
static pub unsafe fn dcsrch(double *f, double *g, double *stp,
...
static pub unsafe fn dcstep(double *stx, double *fx, double *dx,
...
static pub unsafe fn pvector(char *title, double *x, int n) {
{
    Rprintf("%s ", title);
