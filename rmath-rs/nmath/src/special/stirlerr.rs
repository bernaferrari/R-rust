// Ported from R's nmath/stirlerr.c
// stirlerr(n) = log(n!) - log( sqrt(2*pi*n)*(n/e)^n )
//
// Original by Catherine Loader, catherine@research.bell-labs.com. October 23, 2000.
    ...
    if n <= 23.5 {
        ...
        if n <= 5.25 {
            if n >= 1.0 {
                ...
                // n < 1
                return lgammafn1p(n) - (n + 0.5) * log(n) + n - M_LN_SQRT_2PI;
            }
        }
        // else  5.25 < n <= 23.5
        nn = n * n;
