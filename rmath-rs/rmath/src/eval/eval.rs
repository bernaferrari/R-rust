...
fn apply_builtin_safe<'a>(
    ...
    let tmp = match op_name.as_str() {
        ...
        "dir.exists" => unsafe {
            crate::mainutils::platform::do_direxists(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "file" => unsafe {
            crate::mainutils::connections::do_file(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "readLines" => unsafe {
            crate::mainutils::connections::do_readLines(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "simplify2array" => unsafe {
            crate::mainutils::essentials::do_simplify2array(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "match.arg" => unsafe {
            crate::mainutils::essentials::do_match_arg(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "char.expand" => unsafe {
            crate::mainutils::essentials::do_char_expand(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "type.convert" => unsafe {
            crate::mainutils::essentials::do_type_convert(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "as.environment" => unsafe {
            crate::mainutils::essentials::do_as_environment(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "sort.list" => unsafe {
            crate::mainutils::essentials::do_sort_list(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "match.fun" => unsafe {
            crate::mainutils::essentials::do_match_fun(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Logical aggregation
        "any" => unsafe {
            crate::mainutils::essentials::do_any(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "all" => unsafe {
            crate::mainutils::essentials::do_all(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "cumsum" => unsafe {
            crate::mainutils::essentials::do_cumsum(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "cumprod" => unsafe {
            crate::mainutils::essentials::do_cumprod(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Sequence helpers
        "seq_len" => unsafe {
            crate::mainutils::essentials::do_seq_len(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "seq_along" => unsafe {
            crate::mainutils::essentials::do_seq_along(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Difference
        "diff" => unsafe {
            crate::mainutils::essentials::do_diff(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "sort" => unsafe {
            crate::mainutils::essentials::do_sort(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "rev" => unsafe {
            crate::mainutils::essentials::do_rev(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "unique" => unsafe {
            crate::mainutils::essentials::do_unique(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Matrix operations
        "matrix" => unsafe {
            crate::mainutils::essentials::do_matrix(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "diag" => unsafe {
            crate::mainutils::essentials::do_diag(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dim" => unsafe {
            crate::mainutils::essentials::do_dim(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Naming
        "setNames" => unsafe {
            crate::mainutils::essentials::do_setNames(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "names<-" => unsafe {
            crate::mainutils::essentials::do_names_set(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "get" => unsafe {
            crate::mainutils::essentials::do_get(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "assign" => unsafe {
            crate::mainutils::essentials::do_assign(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "ls" => unsafe {
            crate::mainutils::essentials::do_ls(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "rm" => unsafe {
            crate::mainutils::essentials::do_rm(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "%in%" => unsafe {
            crate::mainutils::essentials::do_in_operator(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "inherits" => unsafe {
            crate::mainutils::objects::do_inherits(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Attributes
        "setattr" => unsafe {
            crate::mainutils::essentials::do_setattr(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "stopifnot" => unsafe {
            crate::mainutils::essentials::do_stopifnot(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // System and I/O
        "system" => unsafe {
            crate::mainutils::essentials::do_system(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "tempdir" => unsafe {
            crate::mainutils::essentials::do_tempdir(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "tempfile" => unsafe {
            crate::mainutils::essentials::do_tempfile(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "file.exists" => unsafe {
            crate::mainutils::platform::do_fileexists(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "list.files" => unsafe {
            crate::mainutils::platform::do_listfiles(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "normalizePath" => unsafe {
            crate::mainutils::essentials::do_normalizePath(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // String conversion
        "rawToChar" => unsafe {
            crate::mainutils::essentials::do_rawToChar(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "charToRaw" => unsafe {
            crate::mainutils::essentials::do_charToRaw(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "toString" => unsafe {
            crate::mainutils::essentials::do_toString(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Regex
        "regexpr" => unsafe {
            crate::mainutils::essentials::do_regexpr(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Sampling
        "sample.int" => unsafe {
            crate::mainutils::essentials::do_sample_int(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        // Proc time
        "proc.time" => unsafe {
            crate::mainutils::essentials::do_proc_time(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "as.list.generic" => unsafe {
            crate::mainutils::essentials::do_as_list_generic(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "class<-" => unsafe {
            crate::mainutils::essentials::do_class_set(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dnorm" => unsafe {
            crate::mainutils::essentials::do_dnorm(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pnorm" => unsafe {
            crate::mainutils::essentials::do_pnorm(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qnorm" => unsafe {
            crate::mainutils::essentials::do_qnorm(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dpois" => unsafe {
            crate::mainutils::essentials::do_dpois(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "ppois" => unsafe {
            crate::mainutils::essentials::do_ppois(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dbinom" => unsafe {
            crate::mainutils::essentials::do_dbinom(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pbinom" => unsafe {
            crate::mainutils::essentials::do_pbinom(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dexp" => unsafe {
            crate::mainutils::essentials::do_dexp(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pexp" => unsafe {
            crate::mainutils::essentials::do_pexp(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dgamma" => unsafe {
            crate::mainutils::essentials::do_dgamma(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pgamma" => unsafe {
            crate::mainutils::essentials::do_pgamma(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qgamma" => unsafe {
            crate::mainutils::essentials::do_qgamma(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dbeta" => unsafe {
            crate::mainutils::essentials::do_dbeta(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pbeta" => unsafe {
            crate::mainutils::essentials::do_pbeta(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qbeta" => unsafe {
            crate::mainutils::essentials::do_qbeta(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dt" => unsafe {
            crate::mainutils::essentials::do_dt(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pt" => unsafe {
            crate::mainutils::essentials::do_pt(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qt" => unsafe {
            crate::mainutils::essentials::do_qt(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dchisq" => unsafe {
            crate::mainutils::essentials::do_dchisq(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pchisq" => unsafe {
            crate::mainutils::essentials::do_pchisq(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qchisq" => unsafe {
            crate::mainutils::essentials::do_qchisq(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dcauchy" => unsafe {
            crate::mainutils::essentials::do_dcauchy(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pcauchy" => unsafe {
            crate::mainutils::essentials::do_pcauchy(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qcauchy" => unsafe {
            crate::mainutils::essentials::do_qcauchy(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dweibull" => unsafe {
            crate::mainutils::essentials::do_dweibull(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pweibull" => unsafe {
            crate::mainutils::essentials::do_pweibull(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qweibull" => unsafe {
            crate::mainutils::essentials::do_qweibull(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "df" => unsafe {
            crate::mainutils::essentials::do_df(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pf" => unsafe {
            crate::mainutils::essentials::do_pf(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qf" => unsafe {
            crate::mainutils::essentials::do_qf(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dnbinom" => unsafe {
            crate::mainutils::essentials::do_dnbinom(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pnbinom" => unsafe {
            crate::mainutils::essentials::do_pnbinom(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qnbinom" => unsafe {
            crate::mainutils::essentials::do_qnbinom(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "dgeom" => unsafe {
            crate::mainutils::essentials::do_dgeom(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "pgeom" => unsafe {
            crate::mainutils::essentials::do_pgeom(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        "qgeom" => unsafe {
            crate::mainutils::essentials::do_qgeom(
                call.as_raw(),
                fun.as_raw(),
                evaled_args,
                rho.as_raw(),
        ...
        _ => {
            ...
            if let Some(s3_result) =
                try_s3_dispatch(op_name.as_str(), fun, call, args, rho, evaled_args)
            {
                s3_result
            } else if let Some(s4_result) =
                try_s4_dispatch(op_name.as_str(), fun, call, args, rho, evaled_args)
            {
                s4_result
