...
pub unsafe fn tre_tnfa_run_backtrack(
    ...
    unsafe {
        ...
        let mut _next_c_start: tre_cint_t = 0;
        let mut _str_byte_start: *const u8 = ptr::null();
        let mut pos_start: c_int = -1;

        let mut match_eo: c_int = -1;
        let mut _next_tags: *const c_int = ptr::null();
        let mut _state: *mut tre_tnfa_transition_t = ptr::null_mut();
