...
pub unsafe extern "C" fn bindtextdomain(
    ...
    unsafe { crate::support::intl::bindtextdom::libintl_bindtextdomain(domainname, dirname) }
}
...
pub unsafe extern "C" fn bind_textdomain_codeset(
    ...
    unsafe {
        crate::support::intl::bindtextdom::libintl_bind_textdomain_codeset(domainname, codeset)
    }
}
