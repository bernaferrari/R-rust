...
const TM_SUNDAY: i32 = 0;
const TM_MONDAY: i32 = 1;
const TM_TUESDAY: i32 = 2;
const TM_WEDNESDAY: i32 = 3;
const TM_THURSDAY: i32 = 4;
const TM_FRIDAY: i32 = 5;
const TM_SATURDAY: i32 = 6;

// Month constants
const TM_JANUARY: i32 = 0;
const TM_FEBRUARY: i32 = 1;
const TM_MARCH: i32 = 2;
const TM_APRIL: i32 = 3;
const TM_MAY: i32 = 4;
const TM_JUNE: i32 = 5;
const TM_JULY: i32 = 6;
const TM_AUGUST: i32 = 7;
const TM_SEPTEMBER: i32 = 8;
const TM_OCTOBER: i32 = 9;
const TM_NOVEMBER: i32 = 10;
const TM_DECEMBER: i32 = 11;
...
/// Extract the C format string from a `*const i8` pointer.
unsafe fn fmt_str_from_ptr<'a>(p: *const i8) -> &'a [u8] {
    unsafe {
        if p.is_null() {
            b""
        } else {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn R_strftime(
    s: *mut u8,
    maxsize: usize,
    format: *const i8,
    t: *const stm,
