...
pub fn set_seed(i1: std::os::raw::c_uint, i2: std::os::raw::c_uint) {
    if crate::sexp::instance::with_current_instance(|inst| {
...
pub fn get_seed(i1: *mut std::os::raw::c_uint, i2: *mut std::os::raw::c_uint) {
    ...
    if crate::sexp::instance::with_current_instance(|inst| unsafe {
        *i1 = inst.rng_state.0;
        *i2 = inst.rng_state.1;
    })
    .is_some()
...
pub fn unif_rand() -> f64 {
    if let Some(value) = crate::sexp::instance::with_current_instance(|inst| {
