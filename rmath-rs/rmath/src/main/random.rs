...
use crate::main::main::R_SeedsSymbol;
use crate::main::times::TimeToSeed;
...
impl RNGState {
    fn new() -> Self {
        let mut rng_table: [RNGTab; 8] = std::array::from_fn(|_| RNGTab {
            kind: RNGtype::WICHMANN_HILL,
            n_seed: 0,
            i_seed: vec![],
        });
        // n_seed values matching R's RNG_Table
        rng_table[0] = RNGTab {
            kind: RNGtype::WICHMANN_HILL,
            n_seed: 3,
            i_seed: vec![0; 3],
...
/// Note: no_mangle removed to avoid duplicate symbol with rng.rs.
/// The rng.rs version is the FFI-exported one.
pub(crate) unsafe fn GetRNGstate() {
    unsafe {
...
unsafe fn isNumeric(x: SEXP) -> bool {
    unsafe { crate::main::coerce::isNumeric(x) }
}
...
pub unsafe fn do_random1(_call: SEXP, op: SEXP, args: SEXP, _rho: SEXP) -> SEXP {
    unsafe {
        ...
        match primval {
            0 => {
                let _ = random1_call(crate::nmath::dist::chisq::rchisq, REAL(a), na, REAL(x), n);
            }
            1 => {
                let _ = random1_call(
                    crate::nmath::dist::exponential::rexp,
                    REAL(a),
                    na,
                    REAL(x),
                    n,
            ...
            2 => {
                let _ = random1_call(
                    crate::nmath::dist::geometric::rgeom,
                    REAL(a),
                    na,
                    REAL(x),
                    n,
            ...
            3 => {
                let _ = random1_call(crate::nmath::dist::poisson::rpois, REAL(a), na, REAL(x), n);
            }
            4 => {
                let _ = random1_call(crate::nmath::dist::t_dist::rt, REAL(a), na, REAL(x), n);
            }
            5 => {
                let _ = random1_call(
                    crate::nmath::dist::signrank::rsignrank,
                    REAL(a),
                    na,
                    REAL(x),
                    n,
...
pub unsafe fn do_random2(_call: SEXP, op: SEXP, args: SEXP, _rho: SEXP) -> SEXP {
    unsafe {
        ...
        match primval {
            ...
            1 => {
                let _ = random2_call(
                    crate::nmath::dist::binomial::rbinom,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
            ...
            2 => {
                let _ = random2_call(
                    crate::nmath::dist::cauchy::rcauchy,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
            ...
            6 => {
                let _ = random2_call(
                    crate::nmath::dist::logistic::rlogis,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
            ...
            7 => {
                let _ = random2_call(
                    crate::nmath::dist::nbinom::rnbinom,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
            ...
            9 => {
                let _ = random2_call(
                    crate::nmath::dist::uniform::runif,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
            ...
            10 => {
                let _ = random2_call(
                    crate::nmath::dist::weibull::rweibull,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
            ...
            11 => {
                let _ = random2_call(
                    crate::nmath::dist::wilcox::rwilcox,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
            ...
            12 => {
                let _ = random2_call(
                    crate::nmath::dist::nchisq::rnchisq,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
            ...
            13 => {
                let _ = random2_call(
                    crate::nmath::dist::nbinom::rnbinom_mu,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
...
pub unsafe fn do_random3(_call: SEXP, op: SEXP, args: SEXP, _rho: SEXP) -> SEXP {
    unsafe {
        ...
        match primval {
            0 => {
                let _ = random3_call(
                    crate::nmath::dist::hypergeometric::rhyper,
                    REAL(a),
                    na,
                    REAL(b),
                    nb,
