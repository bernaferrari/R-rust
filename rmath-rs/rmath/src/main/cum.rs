...
pub unsafe fn do_cumsum(_call: SEXP, _op: SEXP, args: SEXP, _env: SEXP) -> SEXP {
    unsafe {
        ...
        if t == SEXPTYPE::CPLXSXP.0 {
            ...
            let t = Rf_protect(crate::main::coerce::coerceVector(s, SEXPTYPE::INTSXP.0));
            let n2 = XLENGTH(t);
            ...
            let t = Rf_protect(crate::main::coerce::coerceVector(s, SEXPTYPE::REALSXP.0));
            let n2 = XLENGTH(t);
...
pub unsafe fn do_cummax(_call: SEXP, _op: SEXP, args: SEXP, _env: SEXP) -> SEXP {
    unsafe {
        ...
        if t == SEXPTYPE::CPLXSXP.0 {
            ...
            let msg = CString::new("'cummax' not defined for complex numbers").expect("CString::new failed: contains null byte");
            Rf_error(msg.as_ptr());
            unreachable!()
        } else if t == SEXPTYPE::INTSXP.0 || t == SEXPTYPE::LGLSXP.0 {
...
pub unsafe fn do_cummin(_call: SEXP, _op: SEXP, args: SEXP, _env: SEXP) -> SEXP {
    unsafe {
        ...
        if t == SEXPTYPE::CPLXSXP.0 {
            ...
            let msg = CString::new("'cummin' not defined for complex numbers").expect("CString::new failed: contains null byte");
            Rf_error(msg.as_ptr());
            unreachable!()
        } else if t == SEXPTYPE::INTSXP.0 || t == SEXPTYPE::LGLSXP.0 {
