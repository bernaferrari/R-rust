...
/// Stub for `scmp` (string comparison from sort.c).
/// Depends on SEXP; not usable without the full R runtime.
pub fn scmp(_x: *const c_void, _y: *const c_void, _nalast: bool) -> c_int {
    0
}
