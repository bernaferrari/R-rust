...
pub unsafe fn R_GE_isPattern(x: SEXP) -> c_int {
    unsafe {
...
unsafe fn check_linear_gradient(pattern: SEXP) {
    unsafe {
...
pub unsafe fn R_GE_linearGradientColour(pattern: SEXP, i: c_int) -> c_uint {
    unsafe {
        check_linear_gradient(pattern);
...
unsafe fn check_radial_gradient(pattern: SEXP) {
    unsafe {
...
pub unsafe fn R_GE_radialGradientColour(pattern: SEXP, i: c_int) -> c_uint {
    unsafe {
        check_radial_gradient(pattern);
...
unsafe fn check_tiling_pattern(pattern: SEXP) {
    unsafe {
