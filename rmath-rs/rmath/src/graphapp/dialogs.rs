...
pub unsafe fn askstring(_question: *const c_char, _default_string: *const c_char) -> *mut c_char {
    ptr::null_mut()
}
pub unsafe fn askpassword(_question: *const c_char, _default_string: *const c_char) -> *mut c_char {
    ptr::null_mut()
}
pub unsafe fn askfilename(_title: *const c_char, _default_name: *const c_char) -> *mut c_char {
    ptr::null_mut()
}
...
pub unsafe fn askfilesave(_title: *const c_char, _default_name: *const c_char) -> *mut c_char {
    ptr::null_mut()
}
...
pub unsafe fn askcdstring(_question: *const c_char, _default_string: *const c_char) -> *mut c_char {
    ptr::null_mut()
}
