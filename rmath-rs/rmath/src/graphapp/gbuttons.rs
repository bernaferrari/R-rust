...
pub unsafe fn getcurrentline(_c: textbox, _line: *mut std::os::raw::c_char, _length: c_int) { /* TODO */
}
...
pub unsafe fn checklimittext(_t: textbox, _n: std::os::raw::c_long) { /* TODO */
}
