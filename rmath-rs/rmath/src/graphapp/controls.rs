...
pub unsafe fn newradiobutton(_text: *const c_char, _r: rect, _fn_: actionfn) -> radiobutton {
    ptr::null_mut() // TODO
}
pub unsafe fn newradiogroup() -> radiogroup {
    ptr::null_mut() // TODO
}
pub unsafe fn newscrollbar(_r: rect, _max: c_int, _pagesize: c_int, _fn_: scrollfn) -> scrollbar {
    ptr::null_mut() // TODO
}
...
pub unsafe fn newdroplist(_list: *const *const c_char, _r: rect, _fn_: scrollfn) -> listbox {
    ptr::null_mut() // TODO
}
pub unsafe fn newdropfield(_list: *const *const c_char, _r: rect, _fn_: scrollfn) -> listbox {
    ptr::null_mut() // TODO
}
...
pub unsafe fn selecttext(_t: textbox, _start: c_long, _end: c_long) { /* TODO */
}
