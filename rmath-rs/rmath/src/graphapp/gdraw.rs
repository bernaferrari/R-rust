...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn gbitblt(_db: bitmap, _sb: bitmap, _p: point, _r: rect) { /* TODO */
}
#[unsafe(no_mangle)]
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn gstrwidth(_d: drawing, _f: font, _s: *const std::os::raw::c_char) -> c_int {
    0
}
#[unsafe(no_mangle)]
