...
use crate::nmath::special::bessel_k::{bessel_k, bessel_k_ex};
...
pub fn bessel_i_c(x: f64, alpha: f64, expo: f64) -> f64 {
...
pub fn bessel_i_ex_c(x: f64, alpha: f64, expo: f64, bi: *mut f64, nb: i32) -> f64 {
    if bi.is_null() || nb <= 0 {
        return ML_NAN;
    }
