...
fn dpois_raw(x: f64, lambda: f64, give_log: bool) -> f64 {
    crate::nmath::dist::gamma::dpois_raw(x, lambda, give_log)
}
...
#[must_use]
pub fn Rf_dnbeta(x: f64, a: f64, b: f64, ncp: f64, give_log: i32) -> f64 {
    dnbeta_inner(x, a, b, ncp, give_log != 0)
}

#[must_use]
pub fn dnbeta(x: f64, a: f64, b: f64, ncp: f64, give_log: i32) -> f64 {
    dnbeta_inner(x, a, b, ncp, give_log != 0)
}

#[must_use]
pub fn Rf_pnbeta(x: f64, a: f64, b: f64, ncp: f64, lower_tail: i32, log_p: i32) -> f64 {
    pnbeta_inner(x, a, b, ncp, lower_tail != 0, log_p != 0)
}

#[must_use]
pub fn pnbeta(x: f64, a: f64, b: f64, ncp: f64, lower_tail: i32, log_p: i32) -> f64 {
    pnbeta_inner(x, a, b, ncp, lower_tail != 0, log_p != 0)
}

#[must_use]
pub fn Rf_qnbeta(p: f64, a: f64, b: f64, ncp: f64, lower_tail: i32, log_p: i32) -> f64 {
    qnbeta_inner(p, a, b, ncp, lower_tail != 0, log_p != 0)
}

#[must_use]
pub fn qnbeta(p: f64, a: f64, b: f64, ncp: f64, lower_tail: i32, log_p: i32) -> f64 {
    qnbeta_inner(p, a, b, ncp, lower_tail != 0, log_p != 0)
}
