...
use crate::nmath::dist::normal::dnorm4_inner;
...
use crate::nmath::rng::*;
use crate::nmath::special::bd0::ebd0;
...
// logcf is imported from crate::nmath::special::gamma::logcf
...
pub fn rgamma_inner(a: f64, scale: f64) -> f64 {
    ...
    with_gamma_state(|state| {
        if a != state.aaa {
            state.aaa = a;
            let r = 1.0 / a;
            state.q0 = ((((((Q7 * r + Q6) * r + Q5) * r + Q4) * r + Q3) * r + Q2) * r + Q1) * r;
