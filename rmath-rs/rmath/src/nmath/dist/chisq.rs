...
pub fn dchisq_inner(x: f64, df: f64, give_log: bool) -> f64 {
    crate::nmath::dist::gamma::dgamma_inner(x, df / 2.0, 2.0, give_log)
}
...
pub fn pchisq_inner(x: f64, df: f64, lower_tail: bool, log_p: bool) -> f64 {
    crate::nmath::dist::gamma::pgamma_inner(x, df / 2.0, 2.0, lower_tail, log_p)
}
...
pub fn qchisq_inner(p: f64, df: f64, lower_tail: bool, log_p: bool) -> f64 {
    crate::nmath::dist::gamma::qgamma_inner(p, 0.5 * df, 2.0, lower_tail, log_p)
}
...
pub fn rchisq_inner(df: f64) -> f64 {
    ...
    crate::nmath::dist::gamma::rgamma_inner(df / 2.0, 2.0)
}
