...
pub unsafe fn tzcode_type() -> SEXP {
    unsafe {
        crate::sexp::constructors::Rf_mkString(
            b"system (macOS)\0".as_ptr() as *const core::ffi::c_char
        )
    }
}
...
pub unsafe fn tzcode_type() -> SEXP {
    unsafe {
        crate::sexp::constructors::Rf_mkString(b"system\0".as_ptr() as *const core::ffi::c_char)
    }
}
