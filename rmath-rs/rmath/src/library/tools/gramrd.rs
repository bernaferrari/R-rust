...
/// yytab: parser action table (stub — 0 entries).
/// In the full implementation, this is the LALR(1) action table
/// generated by Bison from gramRd.y.
#[allow(dead_code)]
static YYTABLE_NINF: c_int = -1;

/// yylhs: left-hand-side symbols for each grammar rule.
/// Stub — in the real implementation, this maps rule numbers to
/// their LHS non-terminal symbol.
#[allow(dead_code)]
static YYLHS_R: [u8; 0] = [];
