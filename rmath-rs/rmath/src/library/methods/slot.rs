...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn R_get_slot(obj: SEXP, name: SEXP) -> SEXP {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn R_set_slot(obj: SEXP, name: SEXP, value: SEXP) -> SEXP {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn R_hasSlot(obj: SEXP, name: SEXP) -> SEXP {
