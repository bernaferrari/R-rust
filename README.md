...
Current release proof: **206/206 stock C R conformance cases pass** in the local
parity suite, with focused unit coverage for packages, S3 registration,
multi-session isolation, UniFFI, and Android plot rendering.
