...
| Vectors, lists, attributes, and objects | 85 | Vectors, typed vector constructors, lists, names, name-preserving repetition, list/complex repetition, subsetting, factors, explicit missing factor levels, generated factors, factor coercion, factor summaries, interval cutting, ordered factors, ordered comparisons, interaction factors, releveling, droplevels, class/attribute replacement, matrices, data frames, S4 slots, and grouped object helpers |
