...
| Base functions, conditions, and platform helpers | 75 | Sorting/set helpers, output capture, conditions, `ls`, `system`/`system2`, `proc.time`, file/temp helpers, wrapping helpers |
