...
| --- | ---: | --- |
| Parser and scalar basics | 59 | Arithmetic, scalar values, comments, infix continuation, parse/deparse/dput/bquote/RDS/unname/expression/mode/comment-attribute/attr-replacement cases, named-argument IO smoke including readLines/writeLines, locale/capability/runtime-introspection/platform/date/umask/Sys.info shape smoke, early object smoke cases |
