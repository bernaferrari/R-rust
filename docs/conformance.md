...
| Vectors, lists, attributes, and objects | 82 | Vectors, typed vector constructors, lists, names, subsetting, factors, explicit missing factor levels, generated factors, factor coercion, ordered factors, ordered comparisons, interaction factors, releveling, droplevels, class/attribute replacement, matrices, data frames, S4 slots, and grouped object helpers |
