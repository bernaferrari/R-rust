...
| Graphics and Android embedding | 5 | Base graphics layout state and external graphics dispatch smoke; broader graphics parity remains tracked separately |
