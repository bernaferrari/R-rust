...
| --- | ---: | --- |
| Parser and scalar basics | 185 | Arithmetic, scalar values, comments, infix continuation, parse/deparse/dput/bquote/RDS/unname/expression/mode/storage-mode/tsp/comment-attribute/attr/attributes/dim/length-replacement, repetition helpers, tabulation, findInterval boundary options including single-break edges, serialize version/ascii header handling, shape-helper, array-creation, and broad parser/runtime smoke cases |
