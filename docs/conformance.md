...
| Vectors, lists, attributes, and objects | 77 | Vectors, typed vector constructors, lists, names, subsetting, factors, explicit missing factor levels, interaction factors, releveling, class/attribute replacement, matrices, data frames, S4 slots, and grouped object helpers |
