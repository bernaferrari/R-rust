...
| --- | ---: | --- |
| Parser and scalar basics | 63 | Arithmetic, scalar values, comments, infix continuation, parse/deparse/dput/bquote/RDS/unname/expression/mode/storage-mode/comment-attribute/attr/attributes/dim/length-replacement cases, named-argument IO smoke including readLines/writeLines, locale/capability/runtime-introspection/platform/date/umask/Sys.info shape smoke, early object smoke cases |
