...
> Historical snapshot from April 2026. Findings and issue states below describe
> that revision, not the current runtime. See the [documentation index](../README.md)
> for maintained contracts and verification commands.
