    ...
    T: 'static,
{
    ...
    let closure_success = wasm_bindgen::closure::Closure::once_aborting(move |_| {
    ...
    let closure_rejected = wasm_bindgen::closure::Closure::once_aborting(move |_| {
        let (success_closure, rejection_closure, callback) =
...
impl dispatch::DeviceInterface for WebDevice {
    ...
    fn set_device_lost_callback(&self, device_lost_callback: dispatch::BoxDeviceLostCallback) {
        let closure = Closure::once_aborting(move |info: JsValue| {
    ...
    fn on_uncaptured_error(&self, handler: Arc<dyn crate::UncapturedErrorHandler>) {
        let f = Closure::wrap_aborting(Box::new(move |event: webgpu_sys::GpuUncapturedErrorEvent| {
